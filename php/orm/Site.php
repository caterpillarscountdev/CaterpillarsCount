...
//FACTORY
	public static function create($creator, $name, $description, $url, $latitude, $longitude, $zoom, $region, $password, $openToPublic) {
		...
		return new Site($id, $creator, $name, date("Y-m-d"), $description, $url, $latitude, $longitude, $region, $salt, $saltedPasswordHash, $openToPublic, true);
	}
...
//FINDERS
	public static function findByID($id) {
		...
		return new Site($id, $creator, $name, $dateEstablished, $description, $url, $latitude, $longitude, $region, $salt, $saltedPasswordHash, $openToPublic, $active);
	}
	...
	public static function findAllActivePublicSites(){
		...
		while($siteRow = mysqli_fetch_assoc($query)){
			...
			$site = new Site($id, $creator, $name, $dateEstablished, $description, $url, $latitude, $longitude, $region, $salt, $saltedPasswordHash, true, $active);
...
//SETTERS
	...
	public function addCircle(){
		if(!$this->deleted)
		{
			email("plocharczykweb@gmail.com", "SITE addCircle debuga1", "1");
			$numberOfPreexistingCircles = (count($this->getPlants()) / 5);
			email("plocharczykweb@gmail.com", "SITE addCircle debuga2", "$numberOfPreexistingCircles");
			email("plocharczykweb@gmail.com", "SITE addCircle debuga3", "site id: " . $this->getID());
			if($numberOfPreexistingCircles < 25){
				...
				email("plocharczykweb@gmail.com", "SITE addCircle debuga4", gettype($a). "|" . json_encode($a));
				return array($a, $b, $c, $d, $e);
			}
			email("plocharczykweb@gmail.com", "SITE addCircle debuga5", "5");
		}
		email("plocharczykweb@gmail.com", "SITE addCircle debuga6", "6");
		return false;
	}
